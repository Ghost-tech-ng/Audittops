...
export default function Reports() {
  ...
  const handleDownloadPDF = () => {
    try {
      console.log("Attempting PDF download/print...");
      if (!checkAndShowLocked("canDownloadReports", "Report Downloads", "Growth")) {
        console.log("PDF download blocked by entitlements");
        return;
      }
      window.print();
      ...
      toast.error("Failed to initiate print/download. Please try again.");
    }
  };
  ...
  const exportExcel = () => {
    try {
      ...
      if (!checkAndShowLocked("canDownloadReports", "Report Downloads", "Growth")) {
        console.log("Excel export blocked by entitlements");
        return;
      }
      if (!reportData) {
        console.log("No report data available for export");
      ...
      toast.error("Failed to export Excel/CSV. Please try again.");
    }
  };
